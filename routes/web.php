...
// Midtrans checkout
Route::post('/payment/midtrans', [PaymentController::class, 'paymentWithMidtrans'])->name('payment.midtrans');
Route::get('/payment/midtrans/success', [PaymentController::class, 'paymentSuccessMidtrans'])->name('payment.midtrans.success');
Route::get('/payment/midtrans/cancel', [PaymentController::class, 'paymentCancel'])->name('payment.midtrans.cancel');

// Midtrans notification (webhook) — POST from Midtrans (no CSRF)
