    ...
    $(function () {
      ...
      var table = $('.data-table').DataTable({
          ...
          columns: [
            ...
            { 
                data: 'status_online_pay', 
                name: 'status_online_pay',
                render: function(data, type, row) {
                    if (data === 'paid') {
                        return '<label class="badge badge-success" style="color:white;">Dibayar</label>';
                    } else {
                        return '<label class="badge badge-danger" style="color:white;">Belum Bayar</label>';
                    }
                }
            },
