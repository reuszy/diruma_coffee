        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="site-settings" style="">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.testimonies.index') }}">Testimoni</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.terms.edit') }}">Syarat & Ketentuan</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.privacy-policy.edit') }}">Kebijakan Privasi</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.general-settings') }}">Pengaturan Umum</a>
                    </li>
                </ul>
            </div>
        </li>
        @endif
              ...
              <li class="nav-item">
                <a target="_blank" class="nav-link" href="{{ route('home') }}">
                  ...
                  <span class="menu-title">Website Diruma</span>
                </a>
              </li>
