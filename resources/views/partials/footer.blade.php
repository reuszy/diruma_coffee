                ...
                <div class="col-xl-6 col-md-6 col-sm-12">
                	<div class="widget">
                        <div class="footer_logo">
                            <a href="index-6.html"><img src="/assets/images/logo_diruma.png" alt="logo"></a>
                        </div>
                        <p>At {{ config('site.name') }}, we pride ourselves on bringing you the authentic flavors of Coffe Purwokerto sing paling enak lik. Our expertly crafted dishes and warm hospitality create a dining experience you won't forget.</p>
                    </div>
                    <div class="widget">
