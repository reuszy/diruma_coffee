                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-2">
                            @if($order->status_online_pay == 'unpaid')
                                <h5 class="text-warning font-weight-bold"><i class="fa fa-clock mr-2"></i> Menunggu Pembayaran</h5>
                            @elseif($order->status == 'pending')
                                <h5 class="text-warning font-weight-bold"><i class="fa fa-clock mr-2"></i> Pesanan Sedang Dibuat</h5>
                            @elseif($order->status == 'delivered')
                                <h5 class="text-info font-weight-bold"><i class="fa fa-truck mr-2"></i> Pesanan Sedang Diantar</h5>
                            @elseif($order->status == 'completed')
                                <h5 class="text-success font-weight-bold"><i class="fa fa-check-circle mr-2"></i> Pesanan Selesai</h5>
