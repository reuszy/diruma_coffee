...
<html lang="en">
  <head>
    ...
    <!-- endinject -->
    <link rel="shortcut icon" href="/favicon_io/cek.png" />
  </head>
  <body>
    ...
    <div class="container-scroller">
      ...
      <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="{{ route('admin.dashboard') }}"><img src="/assets/images/logo_diruma.png" alt="logo"/></a>
